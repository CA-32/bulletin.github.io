...
var style_parcellesderfrences2020avecculturecopier_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("COMMUNE") !== null) {
        ...
        function rules_parcellesderfrences2020avecculturecopier_2(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_parcellesderfrences2020avecculturecopier_2rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_parcellesderfrences2020avecculturecopier_2rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_parcellesderfrences2020avecculturecopier_2(feature, value);
        ;
