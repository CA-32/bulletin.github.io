...
lyr_Departement_32_2.set('fieldLabels', {'RégION': 'no label', 'ID_BDCARTO': 'header label', 'DépARTEMEN': 'no label', 'DépARTEM0': 'no label', 'DépARTEM1': 'no label', 'ORDONNée_D': 'no label', });
