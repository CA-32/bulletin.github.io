...
var format_Parcellesref2022ETE_3 = new ol.format.GeoJSON();
var features_Parcellesref2022ETE_3 = format_Parcellesref2022ETE_3.readFeatures(json_Parcellesref2022ETE_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Parcellesref2022ETE_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Parcellesref2022ETE_3.addFeatures(features_Parcellesref2022ETE_3);
var lyr_Parcellesref2022ETE_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Parcellesref2022ETE_3, 
                style: style_Parcellesref2022ETE_3,
                interactive: true,
    title: 'Parcelles ref 2022 ETE<br />\
    <img src="styles/legend/Parcellesref2022ETE_3_0.png" /> Maïs<br />\
    <img src="styles/legend/Parcellesref2022ETE_3_1.png" /> Maïs Pop Corn<br />\
    <img src="styles/legend/Parcellesref2022ETE_3_2.png" /> Maïs Semence<br />\
    <img src="styles/legend/Parcellesref2022ETE_3_3.png" /> Soja<br />'
        });

lyr_OpenStreetMap_0.setVisible(true);lyr_zonagesbulletins32et65_1.setVisible(true);lyr_Departement_32_2.setVisible(true);lyr_Parcellesref2022ETE_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_zonagesbulletins32et65_1,lyr_Departement_32_2,lyr_Parcellesref2022ETE_3];
...
lyr_Parcellesref2022ETE_3.set('fieldAliases', {'Zone': 'Zone', 'Parcelle': 'Parcelle', 'COMMUNE': 'COMMUNE', 'Type de so': 'Type de so', 'Culture': 'Culture', });
...
lyr_Parcellesref2022ETE_3.set('fieldImages', {'Zone': 'TextEdit', 'Parcelle': 'Range', 'COMMUNE': 'TextEdit', 'Type de so': '', 'Culture': 'TextEdit', });
...
lyr_Parcellesref2022ETE_3.set('fieldLabels', {'Zone': 'inline label', 'Parcelle': 'inline label', 'COMMUNE': 'inline label', 'Type de so': 'inline label', 'Culture': 'inline label', });
lyr_Parcellesref2022ETE_3.on('precompose', function(evt) {
